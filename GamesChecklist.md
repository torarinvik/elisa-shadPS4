...
| [ ] | SHADOW OF THE COLOSSUS | CUSA08809 | Stale checklist entry: not currently present in the local `Games/` folder, so it was not retested in this pass. |
...
| [ ] | Biomutant | CUSA09848 | Stale checklist entry: not currently present in the local `Games/` folder, so it was not retested in this pass. |
